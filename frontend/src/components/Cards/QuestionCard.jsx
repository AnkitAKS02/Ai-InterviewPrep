...
import AIResponsePreview from "../QuestionComponents/AIResponsePreview";
        ...
        <div className="flex items-center justify-end ml-4 relative">
          <div className={`flex ${
            ...
            <button
              ...
              onClick={onTogglePin}>
              {isPinned ? (<PinOff className="text-xs"/>) : (<Pin className="text-xs"/>)}
            </button>
          ...
          <button className="text-gray-400 hover:text-gray-500 cursor-pointer" onClick={toggleExpand}>
            <ChevronDown size={27} className={`transform transition-transform duration-300 ${
