    ...
    <div>
      <div className="p-6 m-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-7 pt-1 pb-6 px-4 md:px-0">
          {/* Add New Resume Card */}
          <div
            className="h-[300px] flex flex-col gap-5 items-center justify-center bg-white rounded-lg border border-purple-400 hover:border-purple-800 hover:bg-purple-50/5 cursor-pointer p-6 m-2"
          ...
          >
            ...
            <h3 className="font-medium text-gray-800">Create New Resumes</h3>
          </div>
