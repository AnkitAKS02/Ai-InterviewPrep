            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-10 lg:p-12 flex flex-col justify-center">
              <div className="text-center max-w-md mx-auto">
                ...
                <p className="text-gray-700 text-lg mb-8 leading-relaxed">
                  AI-powered mock interviews that prepare you for real-world technical challenges.
                </p>
                ...
                <div className="bg-white/60 rounded-xl p-6 border border-white/80">
                  <div className="text-2xl font-bold text-blue-600 mb-2">95% Success Rate</div>
                  <p className="text-gray-600 text-sm">
                    Users who complete our program receive job offers
                  </p>
                </div>
              </div>
            </div>
